...
policies (`db/schema.sql:501-619`) and the check constraints that Prisma cannot express.

**Local Supabase path (2026-08-22 fix — see `AGENTS.md:1`):** `db/schema.sql` is mirrored verbatim to
`supabase/migrations/20260821123132_init_smartkasi.sql:1` (28979 bytes) and `db/seed.sql` to `supabase/seed.sql:1`
