...
1. `db/schema.sql:1` is the source of truth. `supabase/migrations/20260821123132_init_smartkasi.sql:1` is a verbatim copy (28979 bytes, SHA256 `690A9C...`). `supabase/seed.sql:1` is a verbatim copy of `db/seed.sql:1` (18066 bytes). Do not edit the `supabase/` copies alone.
